defmodule PetreeApi.AccountsTest do
  ...
  describe "users" do
    ...
    @valid_attrs %{email: "some email", name: "some name", nickname: "some nickname", password_hash: "some password_hash"}
    @update_attrs %{email: "some updated email", name: "some updated name", nickname: "some updated nickname", password_hash: "some updated password_hash"}
